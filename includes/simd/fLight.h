...
void vray_sampling(fScene *scene, vRay *packed_ray, vHit *packed_pixel_hit_surface, vRGB *packed_pixel_radiance, const float *background_color, int dmax, unsigned int *seed);
